...
void draw_shapes_menu(shape_type selected_shape)
{
    ...
    {
        case RECTANGLE: draw_rectangle(color_black(), MENU_RECT); break;
        case TRIANGLE: draw_triangle(color_black(), MENU_TRIANGLE); break;
        case CIRCLE: draw_circle(color_black(), MENU_CIRCLE); break;
        case ELLIPSE: draw_ellipse(color_black(), MENU_ELLIPSE); break;
        case NONE:
            break;
...
void draw_shape(shape &s)
{
    switch (s.type)
    {
        case RECTANGLE: fill_rectangle(s.fill_color, s.data.rect); break;
        case CIRCLE: fill_circle(s.fill_color, s.data.circ); break;
        case TRIANGLE: fill_triangle(s.fill_color, s.data.tri); break;
        case ELLIPSE: fill_ellipse(s.fill_color, s.data.ellipse); break;
        case NONE: break;
    }  // end switch
}
    ...
    if (d.index < MAX_SHAPES)
    {
        ...
        switch (d.selected_shape)
        {
            ...
            case ELLIPSE:
                ...
                d.index++;
                break;
            default: return;  // jump out if no selected shape...
        }  // end switch
    }  // end if
}  // process pad click
