...
void draw_rocket(color rocket_color, float x, float y, bool thrusters_on)
{
    ...
    if (thrusters_on)
    {
        ...
        // big flame
        fill_triangle(rgb_color(255, 255, 0), x + big_flame_offset, y + ROCKET_HEIGHT,
        ...
        fill_triangle(rgb_color(255, 180, 0), x + little_flame_offset, y + ROCKET_HEIGHT,
...
void load_resources()
{
    load_sound_effect("thrusters", "thrusters.wav");
}
